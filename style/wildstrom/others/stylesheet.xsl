...
<body>
<div class="underlay_left">&#160;</div>
<div class="underlay_top">&#160;</div>
<div class="base">
<div class="brand">
...
<div>
<xsl:if test="../f:frame/h:hierarchy/h:item[descendant-or-self::*/@page=//p:page/@id]/h:item or ../f:frame/f:newsblock or ../f:frame/f:userstatus">
<xsl:attribute name="style">margin-right: 220px;</xsl:attribute>
</xsl:if>
<xsl:apply-templates/>
</div>
...
<form action="{$navigation-path}" method="get" class="search">
<div>
