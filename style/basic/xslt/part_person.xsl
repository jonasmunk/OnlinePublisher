...
<xsl:if test="(../../../pp:display/@initials='true' and p:initials!='') or (../../../pp:display/@nickname='true' and p:nickname!='')">
	<div>
		<xsl:if test="../../../pp:display/@initials='true'"><xsl:value-of select="p:initials"/></xsl:if>
		<xsl:if test="(../../../pp:display/@initials='true' and p:initials!='') and (../../../pp:display/@nickname='true' and p:nickname!='')">/</xsl:if>
		<xsl:if test="../../../pp:display/@nickname='true'"><xsl:value-of select="p:nickname"/></xsl:if>
	</div>
</xsl:if>
<xsl:if test="../../../pp:display/@jobtitle='true' and p:jobtitle!=''"><div class="title"><xsl:value-of select="p:jobtitle"/></div></xsl:if>
<xsl:if test="../../../pp:display/@sex='true'">
<div><span class="part_person_label">K&#248;n: </span>
<xsl:choose>
