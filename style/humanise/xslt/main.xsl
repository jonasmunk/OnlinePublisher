...
var d=function(){return document.body.scrollTop>42},e=d()
e&&o.cls.add(document.body,"scroll"),o.listen(document,"scroll",function(){var c=d()
c!==e&&(o.cls.set(document.body,"scroll",c),e=c)})}),window.devicePixelRatio>1&&(document.body.className+=" retina")
]]></xsl:with-param>
        </xsl:call-template>
		<div class="layout">
	...
	<xsl:if test="f:frame/f:search">
		<form action="{$path}" method="get" class="layout_search" accept-charset="UTF-8">
			...
			<span class="layout_search_body">
                ...
                <button type="reset" class="layout_search_reset">Nulstil</button>
				</xsl:for-each>
