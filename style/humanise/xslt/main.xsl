...
<html>
	...
	<body>
        <xsl:call-template name="util:script-inline">
            ...
            <xsl:with-param name="compiled"><![CDATA[require(["hui"],function(){hui.browser.windows&&hui.cls.add(document.body,"windows"),hui.browser.msie&&hui.cls.add(document.body,"msie"),hui.browser.webkit&&hui.cls.add(document.body,"webkit")}),window.devicePixelRatio>1&&(document.body.className+=" retina")
]]></xsl:with-param>
        </xsl:call-template>
		<div class="layout">
