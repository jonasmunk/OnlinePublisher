...
o&&(n.webkitVersion=parseFloat(o[1]))}(hui,navigator.userAgent,window),hui.log=function(e){try{1==arguments.length?console.log(e):2==arguments.length?console.log(arguments[0],arguments[1]):console.log(arguments)}catch(i){}},hui.defer=function(e,i){i&&(e=e.bind(i)),window.setTimeout(e)},hui.extend=function(e,i){function t(){this.constructor=e}var n=e.prototype
...
t+=s.charAt(0).toUpperCase()+s.substring(1)}return t},trim:function(e){return null===e||void 0===e?"":("string"!=typeof e&&(e=String(e)),e.replace(/^[\s\x0b\xa0\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u200b\u2028\u2029\u3000]+|[\s\x0b\xa0\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u200b\u2028\u2029\u3000]+$/g,""))},wrap:function(e){return null===e||void 0===e?"":e.split("").join("​")},shorten:function(e,i){return hui.isDefined(e)?e.length>i?e.substring(0,i-3)+"...":e:""},escapeHTML:function(e){return null===e||void 0===e?"":hui.build("div",{text:e}).innerHTML},escape:function(e){if(!hui.isString(e))return e
var i={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#x27;","`":"&#x60;"}
...
return t[0]},hui.get.firstChild=hui.dom.firstChild,hui.find=function(e,i){return(i||document).querySelector(e)},hui.collect=function(e,i){var t={}
for(key in e)t[key]=hui.get.firstByClass(i,e[key])
return t},hui.build=function(e,i,t){t=t||document
var n=t.createElement(e)
if(i)for(var o in i)"text"==o?n.appendChild(t.createTextNode(i.text)):"html"==o?n.innerHTML=i.html:"parent"==o&&hui.isDefined(i.parent)?i.parent.appendChild(n):"parentFirst"==o?0===i.parentFirst.childNodes.length?i.parentFirst.appendChild(n):i.parentFirst.insertBefore(n,i.parentFirst.childNodes[0]):"before"==o?i.before.parentNode.insertBefore(n,i.before):"className"==o?n.className=i.className:"class"==o?n.className=i["class"]:"style"==o&&"object"==typeof i[o]?hui.style.set(n,i[o]):"style"==o&&(hui.browser.msie7||hui.browser.msie6)?n.style.setAttribute("cssText",i[o]):hui.isDefined(i[o])&&n.setAttribute(o,i[o])
return n},hui.position={getTop:function(e){if(e=hui.get(e)){for(var i=e.offsetTop,t=e.offsetParent;null!==t;)i+=t.offsetTop,t=t.offsetParent
...
var i=0,t=0
do if(i+=e.scrollTop||0,t+=e.scrollLeft||0,e=e.parentNode,"HTML"===e.tagName)break
while(e)
...
e.className=t}},toggle:function(e,i){hui.cls.has(e,i)?hui.cls.remove(e,i):hui.cls.add(e,i)},set:function(e,i,t){t?hui.cls.add(e,i):hui.cls.remove(e,i)}},hui.listen=function(e,i,t,n){e=hui.get(e),e&&(document.addEventListener?e.addEventListener(i,t,n?!0:!1):e.attachEvent("on"+i,t))},hui.listenOnce=function(e,i,t){var n=null
...
i=i.parentNode}return!1},stop:function(){hui.stop(this.event)}},hui.stop=function(e){e||(e=window.event),e.stopPropagation&&e.stopPropagation(),e.preventDefault&&e.preventDefault(),e.cancelBubble=!0,e.stopped=!0},hui._defered=[],hui._ready="complete"==document.readyState,hui.onReady=function(e){hui._ready?e():hui._defered.push(e),1==hui._defered.length&&hui._onReady(function(){hui._ready=!0
for(var e=0;e<hui._defered.length;e++)hui._defered[e]()
hui._defered=null})},hui.onDraw=function(e){window.setTimeout(e,13)},hui.onDraw=function(e,i){for(var t=i.requestAnimationFrame,n=0;n<e.length&&!t;++n)t=i[e[n]+"RequestAnimationFrame"]
...
if(i){i.onreadystatechange=function(){try{4==i.readyState&&(200==i.status&&e.$success?e.$success(i):403==i.status&&e.$forbidden?e.$forbidden(i):0!==i.status&&e.$failure?e.$failure(i):0===i.status&&e.$abort&&e.$abort(i),e.$finally&&e.$finally())}catch(t){if(!e.$exception)throw t
e.$exception(t,i)}}
...
o&&i.push({name:o,value:s})}return i}},window.define&&define("hui",hui),hui.animate=function(e,i,t,n,o){if("string"==typeof e||hui.dom.isElement(e))hui.animation.get(e).animate(null,t,i,n,o)
...
s.start=Date.now(),o&&o.delay&&(s.start+=o.delay),s.end=s.start+n,hui.animation.start()},hui.animation.TRANSFORM=hui.browser.gecko?"MozTransform":"WebkitTransform",hui.animation.Item.parseTransform=function(e,i){var t,n,o={},s=/rotate\(([0-9\.]+)([a-z]+)\)/i,a=e.match(s)
...
else{var u,r,h,l=6*a,d=Math.floor(l),c=t*(1-i),f=t*(1-i*(l-d)),p=t*(1-i*(1-(l-d)))
0===d?(u=t,r=p,h=c):1===d?(u=f,r=t,h=c):2==d?(u=c,r=t,h=p):3==d?(u=c,r=f,h=t):4==d?(u=p,r=c,h=t):(u=t,r=c,h=f),n=Math.round(255*u),o=Math.round(255*r),s=Math.round(255*h)}return new Array(n,o,s)},hui.Color.rgb2hsv=function(e,i,t){e/=255,i/=255,t/=255
...
n.length<2&&(n="0"+n),i+=n}return i},!function(e,i,t){function n(e,i){g(e,function(e){return!i(e)})}function o(e,t){var n=i.createElement("script"),o=l
n.onload=n.onerror=n[m]=function(){n[f]&&!/^c|loade/.test(n[f])||o||(n.onload=n[m]=null,o=1,t())},n.async=1,n.src=e,s.insertBefore(n,s.firstChild)}var s=i.getElementsByTagName("head")[0],a={},u={},r={},h={},l=!1,d="push",c="DOMContentLoaded",f="readyState",p="addEventListener",m="onreadystatechange",g=function(e,i){for(var t=0,n=e.length;n>t;++t)if(!i(e[t]))return l
return 1}
!i[f]&&i[p]&&(i[p](c,function w(){i.removeEventListener(c,w,l),i[f]="complete"},l),i[f]="loading")
var v=function(e,i,s){function l(e){return e.call?e():a[e]}function c(){if(!--y){a[m]=1,p&&p()
for(var e in r)g(e.split("|"),l)&&!n(r[e],l)&&(r[e]=[])}}e=e[d]?e:[e]
var f=i&&i.call,p=f?i:s,m=f?e.join(""):i,y=e.length
return t(function(){n(e,function(e){return h[e]?(m&&(u[m]=1),void c()):(h[e]=1,m&&(u[m]=1),void o(v.path?v.path+e+".js":e,c))})},0),v}
...
return null},hui.ui.changeState=function(e){if(hui.ui.state!==e){var i,t,n=hui.ui.objects
...
var t=e.findByTag("a")
if(t){var n=i[t.getAttribute("data-path")]
if(!n)return
for(var o=hui.get.byTag(document.body,"a"),s=0;s<o.length;s++)if(n==o[s].getAttribute("name"))return e.stop(),void hui.window.scrollTo({element:o[s].parentNode,duration:1e3,top:"theater"==n?40:140})}}),hui.listen("handmade","click",function(e){hui.stop(e)
...
for(var t=hui.get("head"),n=(hui.get("title"),hui.get("job"),hui.find(".js_broen"),hui.get("about")),o=(hui.get("pressphotos"),hui.find(".theater")),s=hui.get("background1"),a=(hui.get.firstByTag(s,"div"),hui.get("background2")),u=(hui.get.firstByTag(a,"div"),hui.get("background3")),r=(hui.get.firstByTag(u,"div"),hui.find(".theater_photo",o)),h=hui.find(".theater_stages",o),l=hui.get("reelContent"),d=hui.window.getViewWidth(),c=0,f=hui.get.byTag(e,"li"),p=f.length-1;p>=0;p--)c+=f[p].clientWidth+10
hui.browser.animation||(hui.style.setOpacity(r,0),hui.style.setOpacity(h,0)),hui.parallax.listen({element:n,$scroll:function(e){hui.cls.set(n,"visible",.8>e)}}),l&&hui.parallax.listen({element:l,$scroll:function(e){l.style.marginLeft=-400*e-100+"px"}})
var m=0
o&&(hui.parallax.listen({element:o,$scroll:function(e){var i=e>.2&&.8>e&&m>700
...
var t=e>.3&&.7>e
this.shown!=t&&(t&&hui.animate({node:r,css:{opacity:t?1:0},ease:hui.ease.flicker,duration:3e3,$complete:function(){hui.browser.animation?hui.cls.set(o,"is-final",e>0&&1>e):hui.animate({node:h,css:{opacity:t?1:0},ease:hui.ease.slowFast,duration:5e3})}}),this.shown=t)}}),hui.parallax.listen({$resize:function(e,i){m=e,o.style.height=e>700?Math.round(.8*i)+"px":"",hui.browser.mediaQueries||hui.cls.set(document.body,"small",1200>e),d=e}})),hui.parallax.start()}}}
...
hui.ui.listen({$$afterResize:function(){t=hui.position.get(e),n={width:e.clientWidth,height:e.clientHeight}}}),hui.listen(window,"mousemove",function(e){e=hui.event(e)
...
e.dom.remove(i)}}
for(var t=e.get.byClass(document.body,"js-movie-poster"),n=0;n<t.length;n++)new i({element:t[n]})})
