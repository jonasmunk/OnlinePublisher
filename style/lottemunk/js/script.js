...
n.length<2&&(n="0"+n),i+=n}return i},!function(e,i,t){function n(e,i){m(e,function(e){return!i(e)})}function o(e,t){var n=i.createElement("script"),o=l
n.onload=n.onerror=n[g]=function(){n[f]&&!/^c|loade/.test(n[f])||o||(n.onload=n[g]=null,o=1,t())},n.async=1,n.src=e,s.insertBefore(n,s.firstChild)}var s=i.getElementsByTagName("head")[0],a={},u={},r={},h={},l=!1,d="push",c="DOMContentLoaded",f="readyState",p="addEventListener",g="onreadystatechange",m=function(e,i){for(var t=0,n=e.length;n>t;++t)if(!i(e[t]))return l
return 1}
!i[f]&&i[p]&&(i[p](c,function w(){i.removeEventListener(c,w,l),i[f]="complete"},l),i[f]="loading")
var v=function(e,i,s){function l(e){return e.call?e():a[e]}function c(){if(!--y){a[g]=1,p&&p()
...
if(!n)return
for(var o=hui.get.byTag(document.body,"a"),s=0;s<o.length;s++)if(n==o[s].getAttribute("name"))return void hui.window.scrollTo({element:o[s].parentNode,duration:1e3,top:"theater"==n?40:140})}}),hui.listen("handmade","click",function(e){hui.stop(e)
...
for(var t=hui.get("head"),n=(hui.get("title"),hui.get("job"),hui.find(".js_broen"),hui.get("about")),o=(hui.get("pressphotos"),hui.get("theater")),s=hui.get("background1"),a=(hui.get.firstByTag(s,"div"),hui.get("background2")),u=(hui.get.firstByTag(a,"div"),hui.get("background3")),r=(hui.get.firstByTag(u,"div"),hui.get.firstByClass(o,"photo")),h=hui.get.firstByClass(o,"theaters"),l=hui.get("reelContent"),d=hui.window.getViewWidth(),c=0,f=hui.get.byTag(e,"li"),p=f.length-1;p>=0;p--)c+=f[p].clientWidth+10
hui.browser.animation||(hui.style.setOpacity(r,0),hui.style.setOpacity(h,0)),hui.parallax.listen({element:n,$scroll:function(e){hui.cls.set(n,"visible",.8>e)}}),l&&hui.parallax.listen({element:l,$scroll:function(e){l.style.marginLeft=-400*e-100+"px"}}),o&&(hui.parallax.listen({element:o,$scroll:function(e){var i=e>0&&1>e
...
var t=e>.3&&.7>e
this.shown!=t&&(t&&hui.animate({node:r,css:{opacity:t?1:0},ease:hui.ease.flicker,duration:3e3,$complete:function(){hui.browser.animation?hui.cls.set(o,"final",e>0&&1>e):hui.animate({node:h,css:{opacity:t?1:0},ease:hui.ease.slowFast,duration:5e3})}}),this.shown=t)}}),hui.parallax.listen({$resize:function(e,i){o.style.height=Math.round(1*i)+"px",hui.browser.mediaQueries||hui.cls.set(document.body,"small",1200>e),d=e}})),hui.parallax.start()}}}}
