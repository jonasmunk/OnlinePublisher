...
for(var t=hui.get("head"),n=hui.get("title"),o=hui.get("job"),s=hui.find(".js_broen"),a=hui.get("about"),u=(hui.get("pressphotos"),hui.get("theater")),r=hui.get("background1"),h=(hui.get.firstByTag(r,"div"),hui.get("background2")),l=(hui.get.firstByTag(h,"div"),hui.get("background3")),d=(hui.get.firstByTag(l,"div"),hui.get.firstByClass(u,"photo")),c=hui.get.firstByClass(u,"theaters"),f=hui.get("reelContent"),p=hui.window.getViewWidth(),g=0,m=hui.get.byTag(e,"li"),v=m.length-1;v>=0;v--)g+=m[v].clientWidth+10
hui.browser.animation||(hui.style.setOpacity(d,0),hui.style.setOpacity(c,0)),hui.parallax.listen({min:0,max:246,$scroll:function(e){600>p?(t.style.height="",n.style.fontSize="",o.style.left="",o.style.top=""):(t.style.height=146*(1-e)+100+"px",n.style.fontSize=30*(1-e)+50+"px",o.style.left=250*hui.ease.fastSlow(e)+10+"px",o.style.top=-135*e+180+"px"),hui.style.setOpacity(s,1-hui.ease.quadOut(e))}}),hui.parallax.listen({element:a,$scroll:function(e){hui.cls.set(a,"visible",.8>e)}}),f&&hui.parallax.listen({element:f,$scroll:function(e){f.style.marginLeft=-400*e-100+"px"}}),u&&(hui.parallax.listen({element:u,$scroll:function(e){var i=e>0&&1>e
