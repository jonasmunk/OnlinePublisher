...
<xsl:template name="front">
	...
	<section id="about">
		...
		<p class="cv"><a href="javascript://">Curriculum Vitae »</a></p>
		<div class="icons">
			<a href="#" class="icon-linkedin"><xsl:comment/></a>
			<a href="#" class="icon-facebook"><xsl:comment/></a>
			<a href="#" class="icon-twitter"><xsl:comment/></a>
		</div>
	</section>
