...
N2i.Chart.prototype.addDataSet = function(dataSet) {
	this.dataSets[this.dataSets.length] = dataSet;
}

N2i.Chart.prototype.setXaxisLabels = function(labels) {
...
N2i.Chart.DataSet = function(type) {
	type = type ? type : 'line';
	this.dataSets = [];
	this.entries = [];
	this.legend = null;
...
N2i.Chart.DataSet.prototype.addDataSet = function(dataSet) {
	this.dataSets[this.dataSets.length] = dataSet;
}

N2i.Chart.DataSet.prototype.setLegend = function(legend) {
	this.legend = legend;
}

N2i.Chart.DataSet.prototype.isMultiDimensional = function() {
	return this.dataSets.length>0;
}

N2i.Chart.DataSet.prototype.addEntry = function(key,value) {
	this.entries[this.entries.length] = {key:key,value:value};
}


N2i.Chart.DataSet.prototype.setValues = function(graph,values) {
...
N2i.Chart.DataSet.prototype.getEntryValue = function(key) {
	var value = 0;
...
N2i.Chart.DataSet.prototype.getEntryValue2D = function(key) {
	var value = [];
...
N2i.Chart.DataSet.prototype.keysToValues = function(keys) {
	var values = [];
...
N2i.Chart.DataSet.prototype.keysToValues2D = function(keys) {
	var values = [];
	for (var i=0;i<keys.length;i++) {
...
N2i.Chart.DataSet.prototype.getValueRange = function(keys) {
	var vals = [];
...
N2i.Chart.DataSet.prototype.getSubLegends = function() {
	var value = [];
	for (var i=0;i<this.dataSets.length;i++) {
...
N2i.Chart.Renderer = function(graph) {
	this.graph = graph;
	this.crisp = false;
	this.legends = [];
...
N2i.Chart.Renderer.prototype.registerLegend = function(color,label) {
	this.legends[this.legends.length] = {color:color,label:label};
}

N2i.Chart.Renderer.prototype.render = function(canvasId) {
	...
	this.state.yLabels = N2i.Chart.Util.generateYLabels(this.graph);
 ...
 */
N2i.Chart.Renderer.prototype.renderLegends = function() {
 ...
 */
N2i.Chart.Renderer.prototype.renderBody = function() {
...
N2i.Chart.Renderer.prototype.renderPostBody = function() {
	var body = this.graph.body;
	if (this.graph.yAxis.above) {
...
N2i.Chart.Renderer.prototype.getInnerBody = function() {
	var body = this.graph.body;
	var xLabels = this.state.xLabels;
	var space = 0;
...
N2i.Chart.Renderer.prototype.renderLineGraph = function(data) {
...
N2i.Chart.Renderer.prototype.renderColumnGraph = function(data) {
	var values = data.values;
	var xLabels = this.state.xLabels;
	var yLabels = this.state.yLabels;
	var yMin = yLabels[0];
...
N2i.Chart.Renderer.prototype.renderOneColumn = function(val,color,body,innerBody,yMin,yMax,currTop,i,xLabels,space,thickness) {
...
N2i.Chart.Renderer.prototype.renderPie = function(data) {
	
	var values = data.values;
	var colors = data.style.colors ? data.style.colors : this.graph.style.colors;
	var total = N2i.Chart.Util.arraySum(values);
...
N2i.Chart.Util = function() {}

N2i.Chart.Util.generateYLabels = function(graph) {
	var range = N2i.Chart.Util.getYrange(graph);
	var labels = [];
...
N2i.Chart.Util.getYrange = function(graph) {
...
N2i.Chart.Util.arraySum = function(values) {
	var total = 0;
	for (var i=0;i<values.length;i++) {
		total+=values[i];
	}
