hui.ui.listen({
	...
	$valueChanged$level : function(value) {
		...
		this.form.text.className="common_font part_header part_header-"+value;
		for (var i=0;i<=6;i++) {
			hui.cls.remove(partToolbar.section,'part_section_header-'+i);
		}
		hui.cls.add(partToolbar.section,'part_section_header-'+value);
