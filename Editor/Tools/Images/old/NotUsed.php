...
ImagesController::setViewType('notused');
...
'<titlebar title="Billeder ikke i brug" icon="Basic/Stop"/>'.
'<toolbar xmlns="uri:Toolbar" align="left">'.
'<viewgroup title="Visning" value="'.$viewValue.'">'.
'<view type="List" link="NotUsed.php?view=list"/>'.
'<view type="Icon" link="NotUsed.php?view=icon"/>'.
'<view type="Gallery" link="NotUsed.php?view=gallery"/>'.
'</viewgroup>'.
'<divider/>'.
