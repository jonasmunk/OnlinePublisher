...
$enabled = $row['filesenabled'];
$label = $row['fileslabel'];
$default = $row['filesdefault'];
$hidden = $row['fileshidden'];
...
'</radiogroup>'.
'<box title="Sprog:">'.
'<textfield badge="Tekst:" name="label" hint="Den tekst der vises for filer">'.
encodeXML($label).
'</textfield>'.
'</box>'.
