...
$label = $row['newslabel'];
$default = $row['newsdefault'];
$hidden = $row['newshidden'];
...
'<form xmlns="uri:Form" action="UpdateNews.php" method="post" name="Formula" focus="data">'.
...
'</radiogroup>'.
'<box title="Sprog:">'.
'<textfield badge="Tekst:" name="label" hint="Den tekst der vises for nyheder">'.
encodeXML($label).
'</textfield>'.
'</box>'.
