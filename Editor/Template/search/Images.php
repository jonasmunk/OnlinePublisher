...
$enabled = $row['imagesenabled'];
$label = $row['imageslabel'];
$default = $row['imagesdefault'];
$hidden = $row['imageshidden'];
...
'<form xmlns="uri:Form" action="UpdateImages.php" method="post" name="Formula" focus="data">'.
...
'</radiogroup>'.
'<box title="Sprog:">'.
'<textfield badge="Tekst:" name="label" hint="Den tekst der vises for billeder">'.
