...
$enabled = $row['pagesenabled'];
$label = $row['pageslabel'];
$default = $row['pagesdefault'];
$hidden = $row['pageshidden'];
...
'<form xmlns="uri:Form" action="UpdatePages.php" method="post" name="Formula" focus="data">'.
