...
'<tabgroup align="left">';
if ($tab=='text') {
	$gui.='<tab title="Adskiller" style="Hilited"/>';
}
else {
	$gui.='<tab title="Adskiller" link="Toolbar.php?tab=text"/>';
}
if ($tab=='section') {
...
function textTab() {
	...
	'<tool title="Gem" icon="Basic/Save" link="javascript: parent.Editor.document.forms.DividerForm.submit();" target="Editor"/>'.
...
function sectionTab() {
	...
	function updateForm() {
		...
		parent.Editor.document.forms.DividerForm.left.value=leftValue;
		parent.Editor.document.forms.DividerForm.right.value=rightValue;
		parent.Editor.document.forms.DividerForm.top.value=topValue;
		parent.Editor.document.forms.DividerForm.bottom.value=bottomValue;
	...
	function updateThis() {
		Left.setValue(parent.Editor.document.forms.DividerForm.left.value);
		Right.setValue(parent.Editor.document.forms.DividerForm.right.value);
		Top.setValue(parent.Editor.document.forms.DividerForm.top.value);
		Bottom.setValue(parent.Editor.document.forms.DividerForm.bottom.value);
	}
	updateThis();
	</script>'.
	'<flexible/>';
