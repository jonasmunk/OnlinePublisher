...
jsFilesSite = [
    'js/hui.js', 'js/hui_animation.js', 'js/hui_color.js', 'js/hui_require.js', 'js/hui_parallax.js', 'js/ui.js', 'js/ImageViewer.js', 'js/Box.js', 'js/SearchField.js', 'js/Overlay.js', 'js/Button.js'
]
